...
pub struct StrategyStats {
    ...
    /// The last move produced by the exact-CENSUS endgame solver (0.3),
    /// when the position entered the endgame regime. `None` otherwise.
    pub endgame: Option<crate::endgame::EndgameMove>,
}
